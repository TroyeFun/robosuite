...
class SawyerLiftBinobs(SawyerEnv):
    """
    This class corresponds to the lifting task for the Sawyer robot arm.
    Objects and observations used are the same to SawyerPickPlace task,
    rewards are the same to SawyerLift.
    """
    ...
    def __init__(
        ...
        Args:
            ...
            object_choice (str): [ 'milk', 'cereal', 'bread', 'can', 'random']
        """
    ...
    def _get_observation(self):
        ...
        if self.use_object_obs:
            ...
            for obj_str in self.object_params:

                if obj_str == self.object_type:
                    ...
                    obj_pos, obj_quat, rel_pos, rel_quat = \
...
#class SawyerLiftBinobsRandom(SawyerLiftBinobs):
#    def __init__(self, **kwargs):
#        kwargs['object_choice'] = 'random'
#        super().__init__(**kwargs)
#
#class SawyerLiftBinBinobsRandom(SawyerLiftBinobs):
#    def __init__(self, **kwargs):
#        kwargs['object_choice'] = 'random'
