...
from robosuite.environments.sawyer_pick_place_multitask_trainpick import SawyerPickPlaceMultiTask
#from robosuite.environments.sawyer_pick_place_multitask_trainpick_targetobs import SawyerPickPlaceMultiTask
